...
import { Archive, CalendarClock, CirclePlus, Laptop, Settings, Trash2, EllipsisVertical } from 'lucide-react'
                  ...
                  <div key={device.id}
                    ...
                    <div className="flex-1 flex justify-center">
                      <button className="p-2 rounded-full hover:bg-gray-100 transition flex items-center justify-center">
                        <EllipsisVertical className="w-5 h-5 stroke-2 text-primary" />
                      </button>
                    </div>
