...
const AdminHeader = () => {
  ...
  const searchPlaceholder = [
   ...
   { page: "/LaptopRequests", text: "Search registrations..." },
   { page: "/GuardManagement", text: "Search guards by name, role or gate assignment..." },
   { page: "/MovementLogs", text: "Search by Deivce ID..."}
  ];
